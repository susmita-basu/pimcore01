                ...
                if (($h = fopen("import.csv", "r")) !== FALSE) 
                {
                    ...
                    {	
                        ...
                        foreach($data as $prod){
                            ...
                            $object->setLanguageKnown($prod->languageKnown);
                            $object->setDescription($prod->description);
                            $startDate = \Carbon\Carbon::parse($prod->availableFtom);
